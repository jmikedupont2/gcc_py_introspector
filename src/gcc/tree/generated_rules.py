from gcc.tree.attributes import parser_node_rule, parser_rule
...
def p_NTYPE_TYPE_DECL_node(psr_val):
    #    "node : NODE NTYPE_TYPE_DECL TYPE_ATTR NODE  attr_list"
    "node : NODE NTYPE_TYPE_DECL attr_list"


@parser_node_rule
def p_NTYPE_PREDICT_EXPR_node(psr_val):
    "node : NODE NTYPE_PREDICT_EXPR TYPE_ATTR NODE"


@parser_node_rule
def p_NTYPE_TRUTH_AND_EXPR_node(psr_val):
    "node : NODE NTYPE_TRUTH_AND_EXPR TYPE_ATTR NODE  attr_list"
...
def p_NTYPE_DECL_EXPR_node(psr_val):
    "node : NODE NTYPE_DECL_EXPR TYPE_ATTR NODE"


@parser_node_rule
def p_NTYPE_TRUTH_OR_EXPR_node(psr_val):
    "node : NODE NTYPE_TRUTH_OR_EXPR TYPE_ATTR NODE"


@parser_node_rule
def p_NTYPE_MEM_REF_node(psr_val):
    "node : NODE NTYPE_MEM_REF TYPE_ATTR NODE  attr_list"

...
tree = {
    ...
    "exprs": {
        ...
        "node:bind_expr": {
            "fld:body": {"node:return_expr": "30", "node:statement_list": "24"},
        ...
        "node:integer_type": {
            ...
            "fld:name": {"node:identifier_node": "2", "node:type_decl": "157"},
    ...
    "types": {
        ...
        "node:integer_cst": {
            "fld:type": {"node:integer_type": "455", "node:pointer_type": "12"}
        },
        "node:integer_type": {
            "fld:max": {"node:integer_cst": "188"},
            "fld:min": {"node:integer_cst": "188"},
        ...
        "node:nop_expr": {
            "fld:type": {"node:integer_type": "103", "node:pointer_type": "34"}
        },
        "node:parm_decl": {
            "fld:argt": {"node:integer_type": "49", "node:pointer_type": "44"},
            "fld:type": {"node:integer_type": "49", "node:pointer_type": "44"},
        },
        ...
        "node:record_type": {
            ...
            "fld:name": {"node:identifier_node": "89", "node:type_decl": "69"},
...
def recurse_ref(s, subtree):
    ...
    for k in d:
        ...
        if type(st) is dict:
            print(("skip" + st))
            pprint.pprint({"case": "is type", "k": k, "ot": ot, "st": st}, depth=2)
            # pprint.pprint(dt)
            # pass # no type
            ...
            if k.startswith("fld:"):
                ...
                pprint.pprint(
                    {"case": "is literal", "k": k, "dt": dt, "ot": ot, "st": st},
                    depth=2,
                )
                ...
                pprint.pprint(
                    {"case": "is no field", "k": k, "ot": ot, "st": st, "r": r, "v": v},
                    depth=2,
                )
        ...
        if not found:
            ...
            pprint.pprint(
                {"missing": True, "k": k, "ot": ot, "st": st, "u": u, "r": r}, depth=2
            )
        d[k] = r

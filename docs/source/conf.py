...
project = u'gcc.tree.introspector'
copyright = u'2019, James Michael DuPont'
author = u'James Michael DuPont'
...
version = gcc.tree.__version__
# The full version, including alpha/beta/rc tags.
release = gcc.tree.__version__
